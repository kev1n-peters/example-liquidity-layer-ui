...
export class Implementation__factory extends ContractFactory {
  ...
  override deploy(
    ...
    return super.deploy(overrides || {}) as Promise<Implementation>;
  }
  ...
  override attach(address: string): Implementation {
    return super.attach(address) as Implementation;
  }
  override connect(signer: Signer): Implementation__factory {
    return super.connect(signer) as Implementation__factory;
  }
