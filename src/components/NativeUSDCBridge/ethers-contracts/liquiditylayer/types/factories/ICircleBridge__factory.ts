...
import type { ICircleBridge, ICircleBridgeInterface } from "../ICircleBridge";
...
export class ICircleBridge__factory {
  ...
  static createInterface(): ICircleBridgeInterface {
    return new utils.Interface(_abi) as ICircleBridgeInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ICircleBridge {
    return new Contract(address, _abi, signerOrProvider) as ICircleBridge;
  }
}
